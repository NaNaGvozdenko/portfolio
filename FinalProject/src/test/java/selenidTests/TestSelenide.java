...
public class TestSelenide {
    ...
    public void waitUntilColorChangedTest() {
        open("https://demoqa.com/dynamic-properties");
        SelenideElement button = $(By.id("colorChange")).shouldHave(Condition.cssValue("color", "rgba(220, 53, 69, 1)"), Duration.ofSeconds(5,1));
        button.click();
    }

    // Вход в Book store
    @Test
    public void loginBookStoreTest() {
        loginBookStorePage = open("https://demoqa.com/login", LoginBookStorePage.class);
        loginBookStorePage.inputUserName("AdminUser123");
        loginBookStorePage.inputPassword("Admin123*");
        loginBookStorePage.clickLogin();
    }

    // Поиск книги
    @Test
    public void searchBookTest() {
        searchBookPage = open("https://demoqa.com/books", SearchBookPage.class);
        searchBookPage.inputsearchBox("Git Pocket Guide");
        searchBookPage.clickSearch();
    }
